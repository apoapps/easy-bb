...
const materias: Materia[] = [
  {
    ...
    displayName: 'ANALITICA APLICADA',
    ultraStatus: 'ULTRA',
    ...
    actividades: acts('analytics', [
      ['Diagnostico inicial', 95, 100, 'GRADED', '2026-02-05T07:00:00.000Z'],
      ['Practica de indicadores', 88, 100, 'GRADED', '2026-03-12T07:00:00.000Z'],
      ['Reporte de tablero', 92, 100, 'GRADED', '2026-04-23T07:00:00.000Z'],
      ['Entrega integradora', null, 100, 'NEEDS_GRADING', '2026-06-02T07:00:00.000Z'],
    ]),
  },
  {
    courseId: '_demo_course_systems',
    displayName: 'SISTEMAS DIGITALES',
    ultraStatus: 'ULTRA',
    ...
    actividades: acts('systems', [
      ['Laboratorio 1', 86, 100, 'GRADED', '2026-02-20T07:00:00.000Z'],
      ['Examen parcial', 79, 100, 'GRADED', '2026-04-10T07:00:00.000Z'],
      ['Bitacora tecnica', 90, 100, 'GRADED', '2026-05-01T07:00:00.000Z'],
      ['Proyecto final', null, 100, 'IN_PROGRESS', '2026-06-12T07:00:00.000Z'],
    ]),
  },
  {
    courseId: '_demo_course_ethics',
    displayName: 'TALLER DE COMUNICACION',
    ultraStatus: 'ULTRA',
    ...
    actividades: acts('communication', [
      ['Foro de apertura', 100, 100, 'GRADED', '2026-02-15T07:00:00.000Z'],
      ['Ensayo breve', 85, 100, 'GRADED', '2026-03-28T07:00:00.000Z'],
      ['Presentacion oral', 83, 100, 'GRADED', '2026-05-14T07:00:00.000Z'],
      ['Reflexion final', null, 100, 'NOT_ATTEMPTED', '2026-06-15T07:00:00.000Z'],
    ]),
  },
];
